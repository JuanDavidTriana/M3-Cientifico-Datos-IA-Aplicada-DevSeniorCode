# MiniChatGPT Lab — Version en vivo (CLASE)

> **Version docente:** notebook y modulos `src/` con codigo vacio para completar en clase. Solucion completa en `../../MiniChatGPT_Lab/`.
